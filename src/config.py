...
MODEL_CONFIG = {
    "name": "EOR CatBoost",
    "version": "1.0.0",
    "model_file": MODEL_ARTIFACTS_DIR / "eor_model.joblib",
    "encoder_file": MODEL_ARTIFACTS_DIR / "label_encoder.joblib",
    "feature_order_file": MODEL_ARTIFACTS_DIR / "feature_order.json",
}
